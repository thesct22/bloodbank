...
<tr><td class="lefttd">Donor Name:</td><td><input type="text" name="t1" required="required" pattern="[a-zA-Z _]{4,100}" title="please enter only character  between 4 to 15 for donor name" /></td></tr>
