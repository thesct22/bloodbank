...
<div class="wrap">
		<ul class="nav">
			...
			<li class="active"><a href="requests.php">send Request</a></li>
...
<tr><td class="lefttd" align="center"> Name:</td><td><input type="text" name="t1" required="required" pattern="[a-zA-Z _]{5,100}" title="please enter only character  between 5 to 15 for donor name" /></td></tr>
 <tr><td>&nbsp;</td></tr>
